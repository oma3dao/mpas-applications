 ...
 * Upstream: node /tmp/upstash-discovery.YEKdgV/index.js --email YOUR_EMAIL --api-key YOUR_API_KEY
 *
    ...
    if (toolName === "qstash_get_user_token") {
      return {
        content: [
          {
            type: "text",
            text: "This bridge does not return reusable QStash credentials to proposers.",
          },
        ],
        isError: true,
      };

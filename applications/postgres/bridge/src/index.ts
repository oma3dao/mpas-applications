 ...
 * Upstream: node /Users/mpas1/Projects/mcp-targets/postgres/node_modules/@modelcontextprotocol/server-postgres/dist/index.js postgresql://localhost/mydb
 *
...
export class GeneratedBridge {
  ...
  buildMcpServer(): Server {
    const server = new Server(
      {
        name: "example-servers/postgres-mpas-bridge",
        version: "0.1.0",
      },
      {
        capabilities: {

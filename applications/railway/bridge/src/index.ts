 ...
 * Upstream: node /Users/mpas1/Projects/mcp-targets/railway/node_modules/@railway/cli/bin/railway.js mcp
 *
    ...
    if (toolName === "list_variables") {
      return {
        content: [
          {
            type: "text",
            text: "This bridge does not return Railway environment-variable values to proposers.",
          },
        ],
        isError: true,
      };

 ...
 * Upstream: docker run -i --rm -e BIGQUERY_PROJECT -e GOOGLE_APPLICATION_CREDENTIALS us-central1-docker.pkg.dev/database-toolbox/toolbox/toolbox@sha256:bbfdd4f2757e3740cf615ce8d5549a5f7c8fa08ac9352c1bc2c0d08aab62ab1a --prebuilt bigquery --stdio
 *
...
export class GeneratedBridge {
  ...
  async buildMcpServer(): Promise<MpasTasksServer> {
    return new MpasTasksServer({
      ...
      serverInfo: {
        name: "Toolbox-mpas-bridge",
        version: "1.8.0+binary.darwin.arm64.44d1a05+prebuilt.bigquery",
      },
      onerror(error) {

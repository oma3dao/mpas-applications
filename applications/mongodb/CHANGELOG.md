...
- Pinned to `npx -y mongodb-mcp-server@1.14.0`, replacing a local
  `node_modules/mongodb-mcp-server/dist/esm/index.js` path. 1.14.0 matches
  `serverInfo.version` exactly.

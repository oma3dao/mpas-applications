 ...
 * Upstream: npx -y mcp-remote@0.1.37 https://mcp.vercel.com --header Authorization: Bearer {{credential:vercelMcpOAuthAccessToken}}
 *
...
export class GeneratedBridge {
  ...
  async buildMcpServer(): Promise<MpasTasksServer> {
    return new MpasTasksServer({
      ...
      serverInfo: {
        name: "Vercel MCP Server-mpas-bridge",
        version: "0.1.0",
      },
      onerror(error) {
